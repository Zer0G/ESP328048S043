...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Label_Slider, -280);
    lv_obj_set_y(ui_Label_Slider, -380);
    ...
    ui_Temp_Num_Bg1 = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_Temp_Num_Bg1, 80);
    lv_obj_set_height(ui_Temp_Num_Bg1, 120);
    lv_obj_set_x(ui_Temp_Num_Bg1, 332);
    lv_obj_set_y(ui_Temp_Num_Bg1, -75);
    lv_obj_set_align(ui_Temp_Num_Bg1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_Temp_Num_Bg1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_text_font(ui_Label_Celsius1, &ui_font_NumberSmall, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Celsius2 = lv_label_create(ui_Temp_Num_Bg1);
    lv_obj_set_width(ui_Label_Celsius2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Celsius2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_Celsius2, 1);
    lv_obj_set_y(ui_Label_Celsius2, 20);
    lv_obj_set_align(ui_Label_Celsius2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label_Celsius2, "42%");
    ...
    lv_obj_set_style_text_font(ui_Label_Celsius2, &ui_font_NumberSmall, LV_PART_MAIN | LV_STATE_DEFAULT);
